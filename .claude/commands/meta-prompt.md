...
1. Perform scoped project research (grep / glob, max 10 file reads).
2. Write `plan/meta.md` using its specified structure.
3. Surface every ambiguity with a suggested default.
